...
///
/// # Safety
/// The caller must esure that the complete physical memory is mapped at
...
/// Translates `addr` to its mapped physical address, or returns `None` if the address
/// is not mapped.
///
/// # Safety
/// This function is unsafe since passing a wrong address with `physical_memory_offset`
